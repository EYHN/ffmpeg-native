...
$CURL 'https://github.com/BtbN/FFmpeg-Builds/releases/download/latest/ffmpeg-n4.4-latest-win64-gpl-shared-4.4.zip' -o $DOWNLOADS/ffmpeg-n4.4-latest-win64-gpl-shared-4.4.zip
unzip $DOWNLOADS/ffmpeg-n4.4-latest-win64-gpl-shared-4.4.zip -d $DOWNLOADS

mkdir -p $TARGETS/win-x64

FFMPEG_LIB=$DOWNLOADS/ffmpeg-n4.4-latest-win64-gpl-shared-4.4/bin
